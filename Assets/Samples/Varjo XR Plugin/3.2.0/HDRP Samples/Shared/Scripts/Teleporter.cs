...
namespace VarjoExample
{
    public class Teleporter : MonoBehaviour
    {
        ...
        void Update()
        {
            if (controller.primaryButton || controller.TriggerButton || controller.primary2DAxisClick)
            {
                if (!buttonDown)
                {
                    buttonDown = true;
            ...
            else if (!controller.primaryButton && !controller.TriggerButton && !controller.primary2DAxisClick && buttonDown)
            {
                buttonDown = false;
                Teleport();
            }
